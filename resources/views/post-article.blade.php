                ...
                <section class="content col-md-9">
                    <article class="news text-content flex-container"> 
                        <div class="text-content">
                            <h2 class="my-2">{{ $post_article->title }}</h2>
                            <small class="text-muted">Ditulis {{ $post_article->updated_at->diffForHumans() }}</small>
                        </div>

                        <?php $post_image = $post_article['picture']; ?>
